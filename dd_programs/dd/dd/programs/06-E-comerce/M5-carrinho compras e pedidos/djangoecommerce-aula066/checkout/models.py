...
class CartItemManager(models.Manager):
    ...
    def add_item(self, cart_key, product):
        ...
        # se nao existir produto no cariinho add + 1
...
class CartItem(models.Model):
    ...
    #sobrescrevendo o manager padrao
    objects = CartItemManager()

    class Meta:
        verbose_name = 'Item do Carrinho'
        verbose_name_plural = 'Itens dos Carrinhos'
        unique_together = (('cart_key', 'product'),) # index unico com duas chaves

    def __str__(self):
        return '{} [{}]'.format(self.product, self.quantity)

# manager para o pedido
...
# para representar informaçõe gerais do pedido
...
def post_save_cart_item(instance, **kwargs):
    # para remover os itens do carrinho que as quantidades sejam = 0 .
    if instance.quantity < 1:
        instance.delete()

# associando  (post_save_cart_item) ao modelo (CartItem)
