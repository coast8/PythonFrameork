...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'entrada', (
            ...
            ('categoria', self.gf('django.db.models.fields.CharField')(max_length=135)),
        ...
        db.create_table(u'saida', (
            ...
            ('categoria', self.gf('django.db.models.fields.CharField')(max_length=135)),
            ('produto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estoque.Produto'])),
            ('retirante', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['estoque.Retirante'])),
            ('quantidade', self.gf('django.db.models.fields.IntegerField')()),
            ('obs', self.gf('django.db.models.fields.TextField')()),
        ))
