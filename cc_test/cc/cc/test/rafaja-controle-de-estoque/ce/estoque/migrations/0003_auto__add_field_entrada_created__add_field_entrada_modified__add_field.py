...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entrada.created'
        db.add_column(u'entrada', 'created', self.gf('django_extensions.db.fields.CreationDateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Entrada.modified'
        db.add_column(u'entrada', 'modified', self.gf('django_extensions.db.fields.ModificationDateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Saida.created'
        db.add_column(u'saida', 'created', self.gf('django_extensions.db.fields.CreationDateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Saida.modified'
        db.add_column(u'saida', 'modified', self.gf('django_extensions.db.fields.ModificationDateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entrada.created'
        db.delete_column(u'entrada', 'created')

        # Deleting field 'Entrada.modified'
        db.delete_column(u'entrada', 'modified')

        # Deleting field 'Saida.created'
        db.delete_column(u'saida', 'created')

        # Deleting field 'Saida.modified'
        db.delete_column(u'saida', 'modified')
