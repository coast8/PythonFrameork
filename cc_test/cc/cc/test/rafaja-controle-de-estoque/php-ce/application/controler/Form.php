...
class Form {
	...
	function FormCadastro($url,$action,$combos,$ajax){
	...
	function FormEditar($action,$id,$combos,$block){
		...
		echo '<form action="index.php?url='.$this->table.'&acao='.$action.'&id='.$id.'" method="post">'; 
		echo '<table>';
